...
#define HTTPappKey @"cfyfyp319195rc"
#define HTTPappSecret @"45e99384e344e5f76fd7146a32cbb409"
#define HTTPnonce @"987654321"
...
typedef void (^ Success)(NSDictionary* responseObject); // 成功Block
