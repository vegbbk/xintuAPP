...
+(BOOL)isFlightNumber:(NSString *)flightNum{

    NSString *flightNumStr = @"[a-zA-Z0-9]{2}[0-9]{3,5}";
    NSPredicate *emailTest = [NSPredicate predicateWithFormat:@"SELF MATCHES %@", flightNumStr];
    return [emailTest evaluateWithObject:flightNum];
