...
//        }
       ...
       // self.imageView.image = [UIImage imageNamed:photoUrl];
        [self.imageView sd_setImageWithURL:[NSURL URLWithString:photoUrl] placeholderImage:[UIImage imageNamed:defaultImgName]];
