...
@synthesize  payordername;
@synthesize payorderId;
@synthesize payorderprice;
...
// 负责人：李启波（marcyli）
//============================================================
- ( NSMutableDictionary *)sendPayOrde
{

    //订单标题，展示给用户
    NSString *order_name    = self.payordername;
    //订单金额,单位（分）
    NSString *order_price   = self.payorderprice;//1分钱测试
    ...
    NSString *orderno   = self.payorderId;
    ...
    //1商城购物?2打赏?
//    if ([[[NSUserDefaults standardUserDefaults] objectForKey:pay_Money_Goal_Key] integerValue]==1)
//    {
    [packageParams setObject: WX_NOTIFY_URL_STORE        forKey:@"notify_url"];  //支付结果异步通知
//    }else if ([[[NSUserDefaults standardUserDefaults] objectForKey:pay_Money_Goal_Key] integerValue]==2)
//    {
//        [packageParams setObject: WX_NOTIFY_URL_GiveMoney        forKey:@"notify_url"];  //支付结果异步通知
//    }
