...
//    NSLog(@"%@",_model.conversation.ext);
//    if ([_model.conversation.ext[@"LJJnickName"] length] > 0) {
//        self.titleLabel.text = _model.conversation.ext[@"LJJnickName"];
//    }
    // LJJHeadImg;
    if (self.showAvatar){
...
//        if ([_model.conversation.ext[@"LJJHeadImg"] length] > 0) {
//             [self.avatarView.imageView sd_setImageWithURL:[NSURL URLWithString:HTTP_URLIP(_model.conversation.ext[@"LJJHeadImg"])] placeholderImage:_model.avatarImage];
//        }
    }
