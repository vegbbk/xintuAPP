...
#define kTouchToRecord @"按住说话"//NSEaseLocalizedString(@"message.toolBar.record.touch", @"hold down to talk")
#define kTouchToFinish @"松开发送"//NSEaseLocalizedString(@"message.toolBar.record.send", @"loosen to send")
