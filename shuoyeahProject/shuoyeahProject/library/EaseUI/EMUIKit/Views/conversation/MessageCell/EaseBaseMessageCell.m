...
- (void)setModel:(id<IMessageModel>)model
{
    ...
    if([model.message.from isEqualToString:[GVUserDefaults standardUserDefaults].userHXAccount]){
    _nameLabel.text = [GVUserDefaults standardUserDefaults].userName;
    [self.avatarView sd_setImageWithURL:[NSURL URLWithString:HTTP_URLIP([GVUserDefaults standardUserDefaults].userHeadImg)] placeholderImage:model.avatarImage];
    }else{
    _nameLabel.text = [GVUserDefaults standardUserDefaults].DriverHXAccount;
    [self.avatarView sd_setImageWithURL:[NSURL URLWithString:HTTP_URLIP([GVUserDefaults standardUserDefaults].DriverHXHeadImg)] placeholderImage:model.avatarImage];
    }
