...
//    if([_model.buddy isEqualToString:[GVUserDefaults standardUserDefaults].userHXAccount]){
//       self.titleLabel.text = [GVUserDefaults standardUserDefaults].userName;
//       [self.avatarView.imageView sd_setImageWithURL:[NSURL URLWithString:HTTP_URLIP([GVUserDefaults standardUserDefaults].userHeadImg)] placeholderImage:_model.avatarImage];
//    }else{
//       self.titleLabel.text = [GVUserDefaults standardUserDefaults].DriverHXAccount;
//       [self.avatarView.imageView sd_setImageWithURL:[NSURL URLWithString:HTTP_URLIP([GVUserDefaults standardUserDefaults].userHeadImg)] placeholderImage:_model.avatarImage];
//    }
