...

{
    ...
    if(!IsStrEmpty([GVUserDefaults standardUserDefaults].userHeadImg)){
        message.ext = @{@"username":[GVUserDefaults standardUserDefaults].userName,@"headImageUrl":HTTP_URLIP([GVUserDefaults standardUserDefaults].userHeadImg)};
    }else{
       message.ext = @{@"username":[GVUserDefaults standardUserDefaults].userName,@"headImageUrl":@""};
    }
